...
-->
        ...
        <div class="menu-item-carousel">
            <div class="col-lg-12">
                <div class="owl-menu-item owl-carousel">
                    ...
                    <form action="{{ route('add.cart',$foods->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                    <div class="item">
                ...
                <div class="col-lg-4">
                    <div class="chef-item">
                        <div class="thumb">
                            ...
                            <img height="200" width="200" src="foodchef/{{ $ch->image }}">
                        </div>
                        <div class="down-content">
                            <h4>{{ $ch->name }}</h4>
                            <span>{{ $ch->speciality }}</span>
                        </div>
                    </div>
                </div>
                @endforeach
                        ...
                        <form id="contact" action="{{ route('user.reservation') }}" method="post">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                             <input type="number" name="guest" min="0" placeholder="Number Of Guest">
                            </div>
                            <div class="col-lg-6">
                                <div id="filterDate2">    
    ...
    <div class="col-lg-6">
                    <div class="contact-form">
                        <form id="contact" action="{{ route('add.feedback') }}" method="post">
                            @csrf
                          <div class="row">
                            <div class="col-lg-12">
                                <h4>User FeedBack</h4>
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                                <input name="rating" type="number" id="phone" placeholder="Ratting*" min="1" max="5" required="">
                              </fieldset>
                            </div>
                            <div class="col-lg-6">
                                <div id="filterDate2">    
                            ...
                            <div class="col-lg-12">
                              <fieldset>
                                <button type="submit" id="form-submit" class="main-button-icon">Send FeedBack</button>
                              </fieldset>
                            </div>
                          </div>
                        </form>
